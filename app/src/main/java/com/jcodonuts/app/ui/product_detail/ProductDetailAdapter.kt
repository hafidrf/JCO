...
class ProductDetailAdapter @Inject constructor(val onItemClick : ViewHolderListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if(viewType == R.layout.view_holder_product_detail_contents){
        ...
        }else if(viewType == R.layout.view_holder_product_detail_donut_item){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if(holder.itemViewType == R.layout.view_holder_product_detail_contents){
            val vHolder = holder as ViewHolderContent
            vHolder.bind(getItem(position) as ProductDetailContent, position)
        }else if(holder.itemViewType == R.layout.view_holder_product_detail_donut_item){
